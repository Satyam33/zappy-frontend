...
export const mockTemplates: Template[] = [
  { id: 't1', name: 'holi_sale_offer', category: 'marketing', language: 'en', body: 'Hi {{1}}! 🎉 Celebrate Holi with up to 40% off on all products. Use code HOLI40 at checkout. Valid till March 25. Shop now: {{2}}', status: 'approved', createdAt: '2026-02-20T10:00:00Z' },
  { id: 't2', name: 'new_arrivals_march', category: 'marketing', language: 'en', body: 'Hey {{1}}, fresh drops just landed! 🛍️ Check out our latest collection exclusively for our VIP members. Early access link: {{2}}', status: 'approved', createdAt: '2026-03-01T10:00:00Z' },
  { id: 't3', name: 're_engage_v2', category: 'marketing', language: 'en', body: 'We miss you, {{1}}! It\'s been a while. Come back and enjoy a special 20% discount just for you: {{2}}', status: 'approved', createdAt: '2026-02-15T10:00:00Z' },
  { id: 't4', name: 'order_confirmation', category: 'utility', language: 'en', body: 'Hi {{1}}, your order #{{2}} has been confirmed! Expected delivery by {{3}}. Track here: {{4}}', status: 'approved', createdAt: '2026-01-10T10:00:00Z' },
  { id: 't5', name: 'otp_verification', category: 'authentication', language: 'en', body: 'Your Zappy verification code is {{1}}. Valid for 10 minutes. Do not share this code.', status: 'approved', createdAt: '2026-01-05T10:00:00Z' },
  { id: 't6', name: 'flash_sale_urgent', category: 'marketing', language: 'hi', body: 'नमस्ते {{1}}! आज रात 12 बजे तक सभी उत्पादों पर 50% की छूट। जल्दी करें: {{2}}', status: 'pending', createdAt: '2026-03-18T10:00:00Z' },
  { id: 't7', name: 'summer_collection', category: 'marketing', language: 'en', body: 'Beat the heat with our summer collection! {{1}} enjoy exclusive member prices. Shop: {{2}}', status: 'rejected', rejectionReason: 'Template contains promotional content without required opt-out information.', createdAt: '2026-03-10T10:00:00Z' },
]
